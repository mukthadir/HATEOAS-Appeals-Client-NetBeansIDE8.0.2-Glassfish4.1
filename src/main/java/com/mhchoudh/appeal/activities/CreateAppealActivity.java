...
public class CreateAppealActivity {
    public AppealRepresentation create(Appeal appeal, CSE564AppealsUri requestUri) throws InterruptedException {
        ...
        CSE564AppealsUri CSE564AppealsUri = new CSE564AppealsUri(requestUri.getBaseUri() + "/format/" + identifier.toString());
        return new AppealRepresentation(appeal, 
                new Link(Representation.RELATIONS_URI + "cancel", appealUri), 
                new Link(Representation.RELATIONS_URI + "format", CSE564AppealsUri), 
